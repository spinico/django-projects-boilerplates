...
# This tells Django to trust the X-Forwarded-Proto header that comes from our proxy, and any time its value
# is 'https', then the request is guaranteed to be secure (i.e., it originally came in via HTTPS).
